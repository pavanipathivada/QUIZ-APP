let data = [
    ...
    {
        Q : "Q : Where do you place JavaScript code in an HTML file ?",
        a : "In the <title> tag",
        b : "In the <script> tag",
        c : "In the <body> tag only",
        d : "Outside the HTML file ",
        ans:"ans2",
    ...
    {
        Q : "Q :  What does console.log() do ?",
        a : "Shows an error",
        b : "Stops the program",
        c : "Prints to the browser",
